...
extra["langgraph4jVersion"] = "1.7.10"
...
dependencies {
    ...
    implementation("org.bsc.langgraph4j:langgraph4j-spring-ai")
...
dependencyManagement {
    imports {
        ...
        mavenBom("org.bsc.langgraph4j:langgraph4j-bom:${property("langgraph4jVersion")}")
    }
}
